...
class FavoritesContainer extends Component {
    ...
    render() {
        ...
        if (this.props.requesting === false && this.props.message === "" && this.props.favorites.length === 0) return <h2 className="empty-message">You have no favorites at this time. Visit the 'Search Foods' tab to search foods that you can add to your list of favorites or use to create meals.</h2>
        if (this.props.user.loggedIn === true) {
            return (
                <div>
                    <Switch>
